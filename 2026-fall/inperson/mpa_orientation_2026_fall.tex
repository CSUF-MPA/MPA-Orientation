...
\begin{itemize}
  ...
  \item \textbf{NASPAA accredited} since 1989
    \begin{itemize}
      \item Reaccredited through August 2031
    \end{itemize}
\end{itemize}
\end{Large}
\end{frame}
...
\begin{columns}[T,onlytextwidth]
  \column{0.485\textwidth}
    \begin{block}{Accountability}
      Be transparent, responsive, and evidence-informed to earn and sustain public trust.
    \end{block}
...
\begin{columns}[T,onlytextwidth]
  ...
  \begin{itemize}\setlength{\itemsep}{4pt}
    ...
    \item \textbf{Oct. 1 (Thu):} Fall 2027 admission application period opens
  \end{itemize}
