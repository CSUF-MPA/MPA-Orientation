...
\begin{columns}[c,onlytextwidth]
  \column{0.68\textwidth}
    \centering
    \includegraphics[width=\linewidth]{images/join_PASA.png}

  \column{0.28\textwidth}
    \centering
    \includegraphics[width=\linewidth]{images/pasa_interest_qr_2026_27.png}\\[5pt]
    {\small\bfseries 2026--27 Interest Form}
\end{columns}
\end{frame}
...
\begin{frame}{Myungjung ``MJ'' Kwon, Ph.D.}
\begin{columns}[T,onlytextwidth]
  \column{0.66\textwidth}
    \raggedright
  {\large\bfseries Myungjung ``MJ'' Kwon, Ph.D.}\par
    {Professor \& MPA Advisor \quad | \quad \href{mailto:mkwon@fullerton.edu}{mkwon@fullerton.edu}}\par
...
\begin{frame}{Technology You Will Use}
\footnotesize
\begin{columns}[T,onlytextwidth]
  \column{0.5\textwidth}
  \begin{block}{The Workplace Landscape}
    \begin{itemize}\setlength{\itemsep}{3pt}
      \item Microsoft 365 dominates U.S. government productivity software --- roughly \textbf{85\%} by one industry estimate
      \item Google Workspace is a meaningful alternative (about 12\%) and is gaining ground: the U.S. Department of Transportation is moving 50,000+ employees to it
      \item Expect to meet both across a public service career
    \end{itemize}
  \end{block}

  \column{0.5\textwidth}
  \begin{block}{What This Means Here}
    \begin{itemize}\setlength{\itemsep}{3pt}
      \item Most faculty exchange \textbf{Word (.docx)}, \textbf{Excel (.xlsx)}, and \textbf{PowerPoint (.pptx)} files
      \item Some faculty use \textbf{Google Docs} for drafting, feedback, and AI-policy transparency
      \item You are \emph{not} required to use one platform --- Google Workspace, LibreOffice, and the Mac apps are fine
      \item You \emph{are} expected to export reliably to Office formats, and to reopen them to read comments and tracked changes
    \end{itemize}
  \end{block}
\end{columns}

\vspace{0.15em}
{\centering\alert{\textbf{Draft anywhere. Submit in the format the assignment asks for.}}\par}

\vspace{0.15em}
\begin{minipage}{0.8\textwidth}
  {\tiny\raggedright Estimates: Omdia, \emph{Monoculture and Market Share in the US Government} (2021), co-commissioned by Google and CCIA --- an industry estimate, not an official statistic. See also GSA \emph{OneGov Strategy} (2025); U.S.\ DOT/Google Cloud (2025).\par}
\end{minipage}
\end{frame}

\begin{frame}{Free Software from CSUF IT}
\small
\begin{columns}[c,onlytextwidth]
  \column{0.66\textwidth}
  \begin{block}{Microsoft 365 --- Free While You Are Enrolled}
    \begin{itemize}\setlength{\itemsep}{2pt}
      \item Word, Excel, PowerPoint, Outlook, OneNote, and OneDrive
      \item Full desktop versions for \textbf{Windows and Mac}, plus mobile apps
      \item Install on up to \textbf{5 computers}; 50 GB of OneDrive storage
      \item Sign in with your CSUF email at \href{https://m365.cloud.microsoft}{m365.cloud.microsoft} and choose \textbf{Install apps}
    \end{itemize}
  \end{block}

  \vspace{0.2em}
  \textbf{Also available at no cost:} Adobe Creative Cloud, SPSS, NVivo, Qualtrics, Zoom, Dropbox, Grammarly, and LinkedIn Learning.

  \vspace{0.3em}
  \textbf{Student IT Help Desk:} 657--278--8888\\
  \href{mailto:StudentITHelpDesk@fullerton.edu}{StudentITHelpDesk@fullerton.edu}

  \column{0.32\textwidth}
    \centering
    \textbf{CSUF IT Software}\\[6pt]
    \qrcode[height=2.6cm]{https://www.fullerton.edu/it/services/software/}\\[6pt]
    \scriptsize\href{https://www.fullerton.edu/it/services/software/}{fullerton.edu/it/services/software}
\end{columns}
\end{frame}
...
\begin{frame}{Your Next Six Actions}
\large
\begin{enumerate}\setlength{\itemsep}{2pt}
  ...
  \item Install \textbf{Microsoft 365} free from \href{https://www.fullerton.edu/it/services/software/}{\textbf{CSUF IT}}, and confirm you can save and open \texttt{.docx} and \texttt{.xlsx} files.
  \item Join \href{https://fullerton.campuslabs.com/engage/organization/pasa}{\textbf{PASA on TitanLink}}.
  \item Set a second-semester advising reminder and email \href{mailto:mkwon@fullerton.edu}{\textbf{mkwon@fullerton.edu}}.
\end{enumerate}
\end{frame}
...
\textbf{MPA Advisor -- Myungjung ``MJ'' Kwon (GH-523)}\\[-2pt]
\begin{itemize}
