...
\CSUFSetFooterLogo[0.35cm]{images/PUBLIC-ADMINISTRATION-color2.png}
  ...
  \begin{column}{0.33\textwidth}
    ...
    \begin{enumerate}\setlength{\itemsep}{2pt}
      \item \textbf{New Students}
        ...
        \end{itemize}
      \item \textbf{Family/Friends and Current Students}
        \begin{itemize}\setlength{\itemsep}{1pt}
...
\begin{Large}
\begin{itemize}
  \item \textbf{9:1} student--full time faculty ratio
...
\section{\textcolor{titanorange}{MPA Program Website}}
\begin{frame}{MPA Program Website}
\begin{Large}
  \href{https://paj.fullerton.edu/publicadministration/master/}{\textbf{https://paj.fullerton.edu/publicadministration/master/}}\par\vspace{0.6em}
  \textbf{Explore:}
  \begin{itemize}
    \item MPA Home
    \item Mission, Vision \& Values
  ...
  \begin{block}{Academic Support}
    \begin{itemize}\setlength{\itemsep}{4pt}
      ...
      \item \textbf{Computer Labs}\\[-2pt]
        \footnotesize\href{https://www.fullerton.edu/STS/computer_labs}{fullerton.edu/STS/computer\_labs}
    \end{itemize}
  \end{block}
  ...
  \begin{block}{Graduate Support}
    \begin{itemize}\setlength{\itemsep}{4pt}
      ...
      \item \textbf{Graduate Studies Center (GSC)}\\[-2pt]
        \footnotesize\href{https://www.fullerton.edu/graduate/gsc}{fullerton.edu/graduate/gsc}
    \end{itemize}
  \end{block}
\end{columns}
\end{frame}
  ...
  \begin{block}{Money, Records, \& Enrollment}
    \begin{itemize}\setlength{\itemsep}{4pt}
      ...
      \item \textbf{Registrar}\\[-2pt]
        \footnotesize\href{https://www.fullerton.edu/registrar}{fullerton.edu/registrar}
...
\begin{columns}[T,onlytextwidth]
  ...
  \begin{block}{Student Support}
    \begin{itemize}\setlength{\itemsep}{4pt}
      \item \textbf{Career Center}\\[-2pt]
        \footnotesize\href{https://www.fullerton.edu/career}{fullerton.edu/career}
      \item \textbf{Disability Support Services}\\[-2pt]
        \footnotesize\href{https://www.fullerton.edu/DSS}{fullerton.edu/DSS}
      \item \textbf{Veterans Resource Center}\\[-2pt]
        \footnotesize\href{https://www.fullerton.edu/veterans}{fullerton.edu/veterans}
    \end{itemize}
  \end{block}
  ...
  \begin{block}{Identity-Based Resource Centers}
    \begin{itemize}\setlength{\itemsep}{4pt}
      \item \textbf{Women's Center}\\[-2pt]
        \footnotesize\href{https://www.fullerton.edu/womenscenter}{fullerton.edu/womenscenter}
      \item \textbf{Titan Dreamers Resource Center}\\[-2pt]
        \footnotesize\href{https://www.fullerton.edu/tdrc}{fullerton.edu/tdrc}
      \item \textbf{Asian Pacific American Resource Center}\\[-2pt]
        \footnotesize\href{https://www.fullerton.edu/aparc}{fullerton.edu/aparc}
      \item \textbf{Native American \& Indigenous Resource Center}\\[-2pt]
        \footnotesize\href{https://www.fullerton.edu/dirc/resource-centers/naiss.php}{fullerton.edu/dirc/resource-centers/naiss}
      \item \textbf{Losquadro Keller LGBTQ+ Resource Center}\\[-2pt]
        \footnotesize\href{https://www.fullerton.edu/lgbtq}{fullerton.edu/lgbtq}
    \end{itemize}
  \end{block}
\end{columns}
\end{frame}
  ...
  \begin{block}{Basic Needs}
    \begin{itemize}\setlength{\itemsep}{4pt}
      \item \textbf{Tuffy's Basic Needs}\\[-2pt]
        \footnotesize\href{https://www.fullerton.edu/deanofstudents/tuffys_basic_needs}{fullerton.edu/deanofstudents/tuffys\_basic\_needs}
...
\begin{itemize}
  ...
  \item Spring 2026 Office Hours (Virtual and In-Person):
    \begin{itemize}
      \item Mondays: 12:00 PM -- 1:00 PM, 3:00 PM -- 4:00 PM
      \item Wednesdays: 12:00 PM -- 1:00 PM
    \end{itemize}
\end{itemize}
...
\begin{itemize}
  ...
  \item Spring 2026 Office Hours (Virtual and In-Person):
    \begin{itemize}
      \item by appointment at \url{https://dadams.io/appointments}
    \end{itemize}
\end{itemize}
\end{frame}
